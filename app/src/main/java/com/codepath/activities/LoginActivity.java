...
public class LoginActivity extends OAuthLoginActionBarActivity<BitterClient> {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sampleModelDao = ((BitterApp) getApplicationContext()).getMyDatabase().sampleModelDao();
	...
	public void onLoginSuccess() {
		Intent i = new Intent(this, com.codepath.activities.TimelineActivity.class);
		startActivity(i);
	}
